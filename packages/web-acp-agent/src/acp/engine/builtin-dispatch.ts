import type { AgentSideConnection, PromptRequest, PromptResponse, SessionNotification } from "@agentclientprotocol/sdk";
import { type BuiltinHandlerCtx, builtinAvailableCommands, findBuiltin } from "../../agent/commands/builtins";
...
export async function tryHandleBuiltin(args: BuiltinDispatchArgs): Promise<PromptResponse | null> {
	...
	const ctx: BuiltinHandlerCtx = {
		...
		advertisedCommands: [...builtinAvailableCommands(), ...runtime.getAvailableCommands().map(toAvailableCommand)],
