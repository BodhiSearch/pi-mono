import { FEATURE_DEFAULTS } from '@/features/feature-store';
import { BODHI_FEATURES_LIST_METHOD, type BodhiFeaturesListResponse } from '../../index';
import type { ExtMethodHost } from '../types';

export async function featuresList(
  params: unknown,
  host: ExtMethodHost
): Promise<BodhiFeaturesListResponse> {
