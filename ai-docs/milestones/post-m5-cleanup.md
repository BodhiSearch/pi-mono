...
- **Docs.** D16 (options) + D17 (extensions de-exported) appended to `../05-decisions.md`. Library-grade vs app-grade dep classification table added to `../02-architecture.md#Phase-6 extraction shape`. `../plans/we-want-to-create-luminous-book.md` is the full planning record.
